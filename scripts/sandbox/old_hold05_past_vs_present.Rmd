...
- cleaning code base in case we are accepted, having that data/code package ready to go
- prioritizing next papers
   * data cleaning (do we need to re-download everything for other taxa, and if so, why not start that up now?)
   * data analyses
   * refining questions/ writing
- growing the team? might some additional fire power help us achieve the point above?
